...
\begin{center}
\leavevmode
\includegraphics[width=149pt]{space_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em cambia la descripcion del espacio \end{DoxyCompactList}\end{DoxyCompactItemize}
