...
int main(int argc, char *argv[]) {
    ...
    fgets(name_player, WORD_SIZE, stdin);
    name = strtok(name_player, " \n");
    game = game_create_from_file(argv[1], name);
    if (game == NULL) {
    ...
    while ((comand_get_comand(comand) != EXIT) && !game_is_over(game)) {
